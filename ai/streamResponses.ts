...
export default function ai_streamResponses(model: Model, context: Context, options?: StreamOptions): AssistantMessageEventStream {
...
function convertMessages(model: Model, context: Context): ResponseInput {
  ...
  if (context.systemPrompt) {
    ...
    messages.push({ role: role as any, content: ai_sanitizeSurrogates(context.systemPrompt) });
  }
